...
from app.routes.chat_router import router as chat_roter
...
app = FastAPI(
    title="EchoMind",
    description="AI powered assistant for meetings, audio and YouTube videos",
    version="1.0.0",
    lifespan=lifespan,
)
